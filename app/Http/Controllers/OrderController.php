...
class OrderController extends Controller
{
    ...
    {
        $ebooks = Ebook::all();
        $uid = Order::orderBy('id', 'desc')->first();
        ...
        return view('orders.create')->with(['uid' => $uid, 'ebooks' => $ebooks]);
    }
    ...
    public function edit($id)
    {
        ...
        $groups = Group::all();
        return view('orders.edit')->with(['data' => $data, 'subjects' => $subjects, 'classes' => $classes, 'classes' => $classes, 'groups' => $groups]);
    }
    ...
    public function key_download($id)
    {
        ...
        return view('orders.key')->with(['data' => $data]);
