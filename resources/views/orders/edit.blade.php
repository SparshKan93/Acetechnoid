                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="form-select-list">
                                                            <select name="publication" id="publication" class="form-control custom-select-value">
                                                                <option selected>Wellspring Publshing House</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="form-select-list">
                                                            <select name="series" id="series" class="form-control custom-select-value"  value="{{ old('series') }}">
                                                                ...
                                                                <option @if($data->series == 'Wellspring Publshing House') selected @endif >Wellspring Publshing House</option>
                                                                <option @if($data->series == 'The Base') selected @endif>The Base</option>
