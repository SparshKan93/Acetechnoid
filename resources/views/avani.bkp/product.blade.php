	...
	<div class="courses">
		<div class="container">
			...
			<div class="row featured_row">
				<div class="col-lg-6 featured_col">
					<div class="featured_content">
						<div class="featured_title"><h3>Smart Choice Books International</h3></div>
						<div class="featured_header d-flex flex-row align-items-center justify-content-start">
			...
			<div class="row featured_row">
				...
				<div class="col-lg-6 featured_col">
					<div class="featured_content">
						<div class="featured_title"><h3><a href="{{url('product?s=Sarthak Books')}}">Sarthak Books International</a></h3></div>
						<div class="featured_header d-flex flex-row align-items-center justify-content-start">
