                                            ...
                                            <tbody>
                                                @foreach($data as $key => $list)
                                                    <tr>
                                                        ...
                                                        <td>{{$list->title}}</td>
                                                        <td>
                                                            {{$list->Youtube_Embeded}}
                                                        </td>
                                                        <td>{{$list->description}}</td>
                                                        <td>{{$list->created_at}}</td>
                                                        <td style="">
                                                        <!-- <div class="btn-group project-list-action">
                                                            <a class="btn btn-success btn-xs" href="{{ url('ebook-videos/'.$list->id.'/edit') }}"><i class="fa fa-pencil"></i></a>
                                                        </div> -->

                                                            <a href="{{ url('ebook-videos/'.$list->id.'/edit') }}" class="btn btn-warning btn-sm"><span class="fa fa-pencil"></span> Edit</a>


                                                            <form style="display: inline;" method="post" action="{{route('ebook-videos.destroy',$list->id)}}">
                                                                {{ csrf_field() }}
                                                                {{ method_field('DELETE') }}
