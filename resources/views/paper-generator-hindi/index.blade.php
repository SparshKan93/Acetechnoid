                                                ...
                                                @foreach($data as $key => $list)
                                                    <tr>
                                                        ...
                                                        <div class="btn-group project-list-action">
                                                            <a href="{{ url('generate-paper-hindi/'.$list->id.'/edit') }}" class="btn btn-wwarning btn-xs"><i class="fa fa-pencil"></i></a>
                                                            <form style="display: inline;" method="post" action="{{route('generate-paper-hindi.destroy',$list->id)}}">
                                                                {{ csrf_field() }}
                                                                {{ method_field('DELETE') }}
