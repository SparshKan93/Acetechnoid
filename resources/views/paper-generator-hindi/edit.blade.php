                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="all-form-element-inner">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        ...
                                                        <input list="que_types" name="que_type_id" id="que_type" required value="{{ $data->que_type_id }}" class="form-control">
                                        ...
                                        <form style="display: inline;" method="post" action="{{route('generate-paper-hindi.destroy',$data->id)}}">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
                                            <button onclick="return confirm('Are you sure you want to Delete?');" type="submit" class="btn btn-xs btn-danger"><i class="fa fa-delete"></i>Delete</button>
                                        </form>
