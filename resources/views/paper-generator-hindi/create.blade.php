                                        ...
                                        <form id="form" method="post" action="{{route('generate-paper-hindi.store')}}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-select-list">
                                                            <select name="ebook_id" id="ebook_id" class="form-control custom-select-value" required="">
                                                                ...
                                                                @if(Session::has('result'))
                                                                    @php $result = Session::get('result') @endphp
                                                                @endif
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="form-select-list">
                                                            <input list="que_types" name="que_type_id" id="que_type" required value="{{ old('que_type_id') }}" class="form-control">
                                                              <datalist id="que_types">
                                                                @foreach($que_type as $key=>$list)
                                                                @if(!empty($result))
                                                                <option value="{{$list->id}}" @if($list->id==$result->que_type_id) selected @endif >{{$list->name}}</option>
                                                                @else
                                                        ...
                                                        <div class="form-select-list hide">
                                                            <select name="que_type" id="que_type" class="form-control custom-select-value" >
                                            ...
                                            <div class="form-group-inner">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <textarea rows="10" name="question" id="question" type="text" class="form-control" placeholder="Questions"></textarea>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <textarea rows="10" name="answer" id="answer" type="text" class="form-control" placeholder="Answers"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--<div class="form-group-inner">-->
