                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <ul class="breadcome-menu">
                                ...
                                <li><a href="{{ url('hindi-question-categories') }}">Hindi Question Categories</a> <span class="bread-slash">/</span>
                                </li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="all-form-element-inner">
                                        <form id="form" method="post" action="{{route('hindi-question-categories.update',$data->id)}}" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            {{ method_field('PUT') }}
