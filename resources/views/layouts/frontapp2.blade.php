  ...
  <header id="header" class="header-fixed">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="{{ url('test-paper') }}">Home</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 text-lg-left text-center">
          <div class="copyright">
            &copy; Copyright <strong>{{ config('app.name', 'Acetechnoid') }}</strong>. All Rights Reserved
          </div>
          <div class="credits">
            <!--
              ...
              Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/buy/?theme=Acetechnoid
            -->
            Designed by <a href="https://acetechnoid.com/">Acetechnoid Team</a>
          </div>
        </div>
        <div class="col-lg-6">
