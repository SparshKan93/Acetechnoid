            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        <li class="nav-item">
                            <a href="{{ url('dashboard') }}" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-home"></i> <span class="mini-dn">Dashboard</span></a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                ...
                                <a href="{{ url('/hindi-question-categories') }}" class="dropdown-item">Hindi Question Categories</a>
                        ...
                        <li class="nav-item"><a href="{{ url('ebook-videos') }}" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-film"></i> <span class="mini-dn">E Books Videos</span></a>
                        </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-copy-right">
                        ...
                        <p>Developed & Designed by <a target="blank" href="https://acetechnoid.com"><b>Acetechnoid</b></a>.</p>
                    </div>
                </div>
            </div>
        </div>
