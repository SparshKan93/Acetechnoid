                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <ul class="breadcome-menu">
                                ...
                                <li><a href="{{ url('generate-paper') }}">Paper Generator 11</a> <span class="bread-slash">/</span>
                                </li>
                                        ...
                                        <form id="form" method="post" action="{{route('generate-paper.store')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="form-select-list">
                                                             <input list="que_types" name="que_type" id="que_type" required value="@if(!empty($result)) {{ $result->que_type }}  @endif" class="form-control">
