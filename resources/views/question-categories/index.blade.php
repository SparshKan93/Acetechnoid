                                                ...
                                                @foreach($data as $key => $list)
                                                    <tr>
                                                        ...
                                                        <!-- <div class="btn-group project-list-action">
                                                            <a class="btn btn-success btn-xs" href="{{ url('question-categories.'.$list->id.'/edit') }}"><i class="fa fa-pencil"></i></a>
                                                        </div> -->

                                                            <a href="{{ url('question-categories/'.$list->id.'/edit') }}" class="btn btn-warning btn-sm"><span class="fa fa-pencil"></span> Edit</a>


                                                            <form style="display: inline;" method="post" action="{{route('question-categories.destroy',$list->id)}}">
                                                                {{ csrf_field() }}
                                                                {{ method_field('DELETE') }}
