                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="name" data-editable="false">Category Type</th>
                                            ...
                                            <tbody>
                                                @foreach($data as $key => $list)
                                                    <tr>
                                                        ...
                                                        <td>{{$list->id}}</td>
                                                        <td>
                                                            @if($list->category_type == 1) Subject
                                                            @elseif($list->category_type == 2) Standard
                                                            @endif
                                                        </td>
                                                        <td>{{$list->name}}</td>
                                                        ...
                                                        <!-- <div class="btn-group project-list-action">
                                                            <a class="btn btn-success btn-xs" href="{{ url('categories/'.$list->id.'/edit') }}"><i class="fa fa-pencil"></i></a>
                                                        </div> -->

                                                            <a href="{{ url('categories/'.$list->id.'/edit') }}" class="btn btn-warning btn-sm"><span class="fa fa-pencil"></span> Edit</a>


                                                            <form style="display: inline;" method="post" action="{{route('categories.destroy',$list->id)}}">
                                                                {{ csrf_field() }}
                                                                {{ method_field('DELETE') }}
